...
import uk.ac.cam.js2428.mvqa.ml.MobilenetDy;
import uk.ac.cam.js2428.mvqa.ml.VqaPrunedDy;

public class CnnDyLstmPrunedDyModel extends CnnLstmModelBase {
    private MobilenetDy cnn;
    ...
    public CnnDyLstmPrunedDyModel(Context context) {
        super(context);
        ...
        try {
            cnn = MobilenetDy.newInstance(context, options1);
        } catch (IOException e) {
